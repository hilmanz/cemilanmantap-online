...
<div id="modal-add-videos" class="modal fade bd-example-modal-lg" role="dialog" aria-hidden="true">
	<div class="modal-dialog " role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<form id="form-add-videos" action="{{ url('/backadmin/videos') }}" method="post" class="form-horizontal" enctype="multipart/form-data" role="form">
						{{ csrf_field() }}
						{{ method_field('POST') }}
						...
						<div class="col-md-12 mb-20">
							...
							<div style="overflow:hidden;" class="col-md-12 mb-20">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea name="text" class="form-control description" id="" cols="30" rows="10"></textarea>
									</div>
								</div>
								<div class="form-group">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<p class="text-right">
										...
										<button type="button" class="btn btn-primary bg-cokelat submit-videos">Save</button>
