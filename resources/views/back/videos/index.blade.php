	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="col-md-12">
					<button id="add-videos" class="btn btn-lg btn-datatalk mbt10">New Videos</button>
				</div>
						...
						<table class="table table-striped table-bordered text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<button data-id="{{$data->id}}" class="edit-videos btn btn-sm btn-default">
...
<div class="message-box message-box-danger animated fadeIn" data-sound="fail" id="mb-delete">
	<div class="mb-container">
		<div class="mb-middle">
			...
			<div class="mb-footer">
				<form id="delete-videos" style="display:block;"  class="form-horizontal" action="" method="post" accept-charset="utf-8">
					{{ csrf_field() }}
					{{ method_field('DELETE') }}
					<input style="color:#000;" type="hidden" name="id" value="" id="delete-id"  />
				</form>
				<button onclick="event.preventDefault();
				document.getElementById('delete-videos').submit();"  class="btn btn-primary btn-lg pull-right mb-control-close">Yes</button>
...
@include('back.modal.add_videos')
@include('back.modal.edit_videos')
@include('back.modal._list_media')
@stop
@push('scripts')
<script type="text/javascript" src="{{url('/').mix('back_assets/js/scripts/videos_index.min.js')}}"></script>
@endpush