	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="col-md-12">
					<button id="add-event" class="btn btn-lg btn-datatalk mbt10">New Event</button>
				</div>
						...
						<table class="table table-striped table-bordered text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$data->title}}</td>
									<td>
										@foreach($data->posts_role_categories as $val)
									...
									<td>
										<button data-id="{{$data->id}}" class="edit-event btn btn-sm btn-default">
...
@include('back.modal.add_event')
@include('back.modal.edit_event')
@include('back.modal._list_media')
@stop
@push('scripts')
<script type="text/javascript" src="{{url('/').mix('back_assets/js/scripts/posts_event.min.js')}}"></script>
@endpush