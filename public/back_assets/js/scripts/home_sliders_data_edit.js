	...
	$(".submit-edit-slider").click(function(){
		$(".submit-edit-slider").prop("disabled", true).css("cursor", 'not-allowed');
		$(".loading-button").css("display", 'inline-block');
			$("#form-edit-homesliders").ajaxForm(
				{
					target: '.preview',
					beforeSend: function() {
				...
				success: function(data) {
					if(data.status == 'success'){
						...
						$(".submit-edit-slider").prop("disabled", false).css("cursor", 'pointer');
