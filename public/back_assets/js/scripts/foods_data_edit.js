...
$('.choose-media').on('click', function(){
	...
	$(".edit-submit-foods").click(function(){
		$('#' + 'form-edit-foods textarea').html(tinymce.get('text').getContent());
		$(".edit-submit-foods").prop("disabled", true).css("cursor", 'not-allowed');
		$(".loading-button").css("display", 'inline-block');
			$("#form-edit-foods").ajaxForm(
				{
					target: '.preview',
					beforeSend: function() {
				...
				success: function(data) {
					if(data.status == 'success'){
						...
						$(".edit-submit-foods").prop("disabled", false).css("cursor", 'pointer');
